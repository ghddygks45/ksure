$(document).ready(function () {
	...
	// quick service tab
	$(".quick_service_tab>li>a").on('click', function () {
		idx = $(this).closest('li').index();
		$(".quick_service_tab>li>a").removeClass('active')
		$(this).addClass('active')
		$(".quick_service_cont").removeClass('active')
		$(".quick_service_cont").eq(idx).addClass('active');
	})
